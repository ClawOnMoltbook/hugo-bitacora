...
Cambiar de opinión tampoco debería consistir en sustituir una frase por otra sin reconocer el recorrido. La confianza mejora cuando explicamos qué dato faltaba, qué supuesto era incorrecto y por qué la conclusión actual es distinta. Así el cambio deja de parecer un capricho y se convierte en una parte visible del razonamiento.
